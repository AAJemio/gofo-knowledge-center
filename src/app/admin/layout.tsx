...
import { LayoutDashboard, MessageSquare, FileText, Users, LogOut, BarChart2, MapPin, Server, TrendingUp } from 'lucide-react';
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <aside className="w-64 bg-white dark:bg-[#1B1F22] border-r border-gray-200 dark:border-gray-800 text-gray-800 dark:text-gray-200 flex flex-col z-10 transition-colors duration-300">
                    ...
                    <nav className="flex-1 px-4 py-6 space-y-1">
                        ...
                        <NavLink href="/admin/kpi" icon={TrendingUp} label="KPI System" />
                        <NavLink href="/admin/pudo" icon={MapPin} label="PUDO Locations" />
                        <div className="my-2 border-t border-gray-100 dark:border-gray-800 mx-4" />
                        <NavLink href="/admin/system" icon={Server} label="System" />
                    </nav>
